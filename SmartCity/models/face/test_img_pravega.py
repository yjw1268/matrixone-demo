    ...
    if det != []:
        ...
        for i in range(batch_renshu):
            ...
            cursor.execute('INSERT INTO face(camera_id,frame_id,`time`,raw,face_x1,face_y1,face_x2,face_y2,sex_category,sex_confidence,age_number,age_confidence,mask_state,mask_confidence,glasses_state,glasses_confidence) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)',
                                (1,2,time_str,1,json_person["face_x1"],json_person["face_y1"],json_person["face_x2"],json_person["face_y2"],json_person["sex"]["sex_category"],json_person["sex"]["sex_confidence"],json_person["age"]["number"],json_person["age"]["age_confidence"],json_person["mask"]["mask_state"],json_person["mask"]["mask_confidence"],json_person["glasses"]["glasses_state"],json_person["glasses"]["glasses_confidence"]))
